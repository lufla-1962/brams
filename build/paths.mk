...
JULES_IMMAP=$(JULES_DIR)/LIB/SOURCE/IMOGEN/MODULES/MAP
JULES_IMPAR=$(JULES_DIR)/LIB/SOURCE/IMOGEN/MODULES/PARAMS
JULES_IMVAR=$(JULES_DIR)/LIB/SOURCE/IMOGEN/MODULES/VARS
JULES_IMSUB=$(JULES_DIR)/LIB/SOURCE/IMOGEN/SUBROUTINES
JULES_MCTRL=$(JULES_DIR)/LIB/SOURCE/MODULES/CONTROL
JULES_MPARA=$(JULES_DIR)/LIB/SOURCE/MODULES/PARAMS
JULES_SCTRL=$(JULES_DIR)/LIB/SOURCE/SUBROUTINES/CONTROL
JULES_SINIT=$(JULES_DIR)/LIB/SOURCE/SUBROUTINES/INITIALISATION
JULES_SRADT=$(JULES_DIR)/LIB/SOURCE/SUBROUTINES/RADIATION
JULES_SSNOW=$(JULES_DIR)/LIB/SOURCE/SUBROUTINES/SNOW
JULES_SSOIL=$(JULES_DIR)/LIB/SOURCE/SUBROUTINES/SOIL
JULES_SSURF=$(JULES_DIR)/LIB/SOURCE/SUBROUTINES/SURFACE
JULES_SVEGT=$(JULES_DIR)/LIB/SOURCE/SUBROUTINES/VEGETATION
JULES_UNCDF=$(JULES_DIR)/LIB/UTILS/netcdf_dummy
JULES_UDRHD=$(JULES_DIR)/LIB/UTILS/drhook_dummy
