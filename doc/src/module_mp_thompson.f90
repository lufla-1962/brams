      ...
      IF ( wrf_dm_on_monitor) THEN
        ...
        IF ( lexist ) THEN
          ...
          if(mchnum==master_num) &
            write (logUnit,fmt='(A)') "ThompMP: read qr_acr_qg.dat instead of computing"
...
!       INQUIRE(FILE="qr_acr_qs.dat",EXIST=lexist)
        ...
        IF ( lexist ) THEN
          ...
          if(mchnum==master_num) &
            write (logUnit,fmt='(A)') "ThompMP: read qr_acr_qs.dat instead of computing"
...
!     CALL nl_get_write_thompson_tables(1,write_thompson_tables)
      ...
      IF ( wrf_dm_on_monitor ) THEN
        ...
        IF ( lexist ) THEN
          ...
          if(mchnum==master_num) &
            write (logUnit,fmt='(A)') "ThompMP: read freezeH2O.dat instead of computing"
