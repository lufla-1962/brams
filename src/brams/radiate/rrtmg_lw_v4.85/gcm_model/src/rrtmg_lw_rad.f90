...
!  Vertical indexing goes from bottom to top; reverse here for GCM if necessary.
         ...
         enddo
         do k = 0, nlayers-1 !srf - change from "nlayers-1" to "nlauers-2"
...
!	 cldfmc(1:ngptlw,nlayers) = 0.0_rb
!	 ciwpmc(1:ngptlw,nlayers) = 0.0_rb
!	 clwpmc(1:ngptlw,nlayers) = 0.0_rb
