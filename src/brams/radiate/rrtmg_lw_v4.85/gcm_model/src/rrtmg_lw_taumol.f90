...
!             print *,"LFR->TAUMOL 353 - ig,lay: ",ig,lay
!	     print*,"LFR -> ",size(fracs,1),size(fracs,2),size(fracrefa,1)
!	     print*,"LFR -> ",fracrefa(ig)
!             print*,"LFR -> ",fracs(lay,ig); call flush(6)
         ...
         do ig = 1, ng1
            ...
            taug(lay,ig) = corradj * (colh2o(lay) * &
                (fac00(lay) * absb(ind0,ig) + &
                 ...
                 + taufor + taun2)
!             print *,"LFR->TAUMOL 383 - ig,lay: ",ig,lay
!             print*,"LFR -> ",size(fracs,1),size(fracs,2),size(fracrefa,1)
!             print*,"LFR -> ",fracrefa(ig)
!             print*,"LFR -> ",fracs(lay,ig); call flush(6)
                fracs(lay,ig) = fracrefa(ig)
