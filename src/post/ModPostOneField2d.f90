	 ...
	 TotPrec= ScrT2N02 + ScrT2N01  ! save for the next step
      ...
      case ('RV2MJ')
         ...
         if (time==0.) then
            ...
            OutputField3d = OutputField3d * 1.e3
            OutputField3d = max(OutputField3d, 0.0)
...
!LFR
      ...
      case ('UPMF')
         call GetVarFromMemToOutput ('UPMF', oneBramsGrid%currGrid, OutputField)
      case ('SHMF')
         call GetVarFromMemToOutput ('UPMFSH3', oneBramsGrid%currGrid, OutputField)
